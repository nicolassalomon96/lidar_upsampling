...
def pointcloud_to_range_image(pointcloud, v_res=0.42, h_res=0.35, v_fov=(-24.9, 2.0), h_fov=(-180,180), size=(64,1024), lidar_16_ch=False, format='kitti', filter_ego_compensed=False, kind='distance', return_angles=False):
    '''
