...
def dump_predicted_labels(file_path, predictions):
    ...
    with open(file_path, 'w') as out_label_file:
        for predicted_box_parameters in predictions:
            ...
            out_label.append(round(float(predicted_box_parameters.truncation), 2)) # BB truncation
            out_label.append(round(float(predicted_box_parameters.occlusion), 2)) # BB occlusion level
            out_label.append(round(float(predicted_box_parameters.alpha), 2)) # BB observation angle
            out_label.append(round(float(predicted_box_parameters.box2d[0]), 2)) # 2D BB top
            out_label.append(round(float(predicted_box_parameters.box2d[1]), 2)) # 2D BB left
            out_label.append(round(float(predicted_box_parameters.box2d[2]), 2)) # 2D BB bottom
            out_label.append(round(float(predicted_box_parameters.box2d[3]), 2)) # 2D BB right
            out_label.append(round(float(predicted_box_parameters.h), 2)) # 3D BB height
            out_label.append(round(float(predicted_box_parameters.w), 2)) # 3D BB width
            out_label.append(round(float(predicted_box_parameters.l), 2)) # 3D BB length
            out_label.append(round(float(predicted_box_parameters.t[0]), 2)) # 3D BB x
            out_label.append(round(float(predicted_box_parameters.t[1]), 2)) # 3D BB y
            out_label.append(round(float(predicted_box_parameters.t[2]), 2)) # 3D BB z 
            out_label.append(round(float(predicted_box_parameters.ry), 2)) # BB rotation around y-axis
            out_label.append(round(float(predicted_box_parameters.score), 2)) # BB prediction score
            '''
            out_label.append(predicted_box_parameters.type) # BB class
