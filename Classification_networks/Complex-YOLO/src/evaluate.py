...
def parse_eval_configs():
    ...
    ####################################################################
    configs.working_dir = '../'
    #configs.dataset_dir = r'D:\Nicolas\Posgrado\Trabajos y Tesis\LIDAR\Datasets LIDAR\kitti\kitti_3d_object' #Dataset original
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load(configs.pretrained_path, map_location=torch.device('cuda')))
