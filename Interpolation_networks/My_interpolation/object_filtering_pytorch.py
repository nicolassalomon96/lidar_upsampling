...
if __name__ == "__main__":
        ...
        range_image_inter = np.load(r'.\range_images\interpolada_mired.npy')
        ...
        save_path_or_64 = r'.\result_pointclouds\original_64.ply'
        save_ply(pointcloud_64[0].detach().cpu().numpy(), save_path_or_64)

        save_path_or = r'.\result_pointclouds\puntos_originales_filtrados.ply'
        save_ply(filtered_points[0].detach().cpu().numpy(), save_path_or)

        save_path_red = r'.\result_pointclouds\puntos_reducidos_filtrados.ply'
        save_ply(filtered_points_32[0].detach().cpu().numpy(), save_path_red)
        
        save_path = r'.\result_pointclouds\puntos_interpolados_filtrados.ply'
