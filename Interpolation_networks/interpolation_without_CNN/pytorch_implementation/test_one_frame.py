...
#mlp_net = Approx_net(input_size=8, hidden_neurons_1=20, hidden_neurons_2=10, hidden_neurons_3=6, output_size=1)
#mlp_net = Approx_net(input_size=8, hidden_neurons_1=10, hidden_neurons_2=6, hidden_neurons_3=6, output_size=1)
#mlp_net.load_state_dict(torch.load(r'D:\Nicolas\Posgrado\Trabajos y Tesis\LIDAR\LIDAR_super_resolution\Scripts\otras_arquitecturas\3_pytorch_interpolation\results\mlp_81061\model_Leaky_ReLU_81061_40ep_fulldataset_MAE\model_Leaky_ReLU_81061_fulldataset_ep32.pth'))
mlp_net.load_state_dict(torch.load(r'D:\Nicolas\Posgrado\Trabajos y Tesis\LIDAR\LIDAR_super_resolution\Scripts\otras_arquitecturas\3_pytorch_interpolation\results\mlp_8201061\model_Leaky_ReLU_8201061_30ep_fulldataset_Chamfer\best_816841_kitti3d_Chamfer_Rprop_val035\best_val03564.pth'))
device = 'cpu'
...
#hr_range_distance_image = pointcloud_to_range_image(pointcloud, filter_ego_compensed=True, kind='both', size=(64,1024))
#hr_range_distance_image = pointcloud_to_range_image(pointcloud, filter_ego_compensed=True, kind='intensity', size=(64,1024))
...
save_PATH = r'D:\Nicolas\Posgrado\Trabajos y Tesis\LIDAR\LIDAR_super_resolution\pruebas_resultados\b.ply'
