...
mlp_net.load_state_dict(torch.load(r'.\models_result\best_616841_0.0038.pth'))
device = 'cpu'
...
twindows_stack = twindows.reshape(twindows.shape[0] * twindows.shape[1], twindows.shape[2])
pixels = mlp_net(twindows_stack)#.squeeze()
...
save_PATH = r'.\result_pointclouds\prueba_616841_1024.ply'
