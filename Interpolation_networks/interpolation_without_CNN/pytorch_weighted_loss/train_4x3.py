...
class ChamferLoss(nn.Module):
    ...
    def forward(self, image_pred, image_gt, label_path):
        ...
        if self.separate_pointcloud:
            ...
            #save_path = r'C:\Users\Nicolas\Desktop\puntos_gt_non_filtrados_prueba.ply'
            #save_ply(pointcloud_gt_non_filtered[0].detach().cpu().numpy(), save_path)

            #save_path = r'C:\Users\Nicolas\Desktop\puntos_gt_filtrados_prueba.ply'
            #save_ply(pointcloud_gt_filtered[0].detach().cpu().numpy(), save_path)

            #save_path = r'C:\Users\Nicolas\Desktop\puntos_pred_non_filtrados_prueba.ply'
            #save_ply(pointcloud_pred_non_filtered[0].detach().cpu().numpy(), save_path)

            #save_path = r'C:\Users\Nicolas\Desktop\puntos_pred_filtrados_prueba.ply'
            #save_ply(pointcloud_pred_filtered[0].detach().cpu().numpy(), save_path)

            #save_path = r'C:\Users\Nicolas\Desktop\puntos_gt_prueba.ply'
            #save_ply(pointcloud_gt[0].detach().cpu().numpy(), save_path)
            ...
            #print(chamfer_loss_filtered_tensor.max(), chamfer_loss_filtered_tensor.min(), chamfer_loss_filtered_tensor.shape)
            #print(chamfer_loss_non_filtered_tensor.max(), chamfer_loss_non_filtered_tensor.min(), chamfer_loss_non_filtered_tensor.shape)
            ...
            #print(chamfer_loss.max(), chamfer_loss.min(), chamfer_loss.shape)
            #print(chamfer_loss)
