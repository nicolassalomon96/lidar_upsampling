...
lr_folder = os.path.join(path_folder, r'Datasets LIDAR\kitti_carla_merged\range_image_16ch') #Low resolution images path
hr_folder = os.path.join(path_folder, r'Datasets LIDAR\kitti_carla_merged\range_image_64ch') #High resolution images path
