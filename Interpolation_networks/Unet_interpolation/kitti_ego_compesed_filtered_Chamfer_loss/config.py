...
lr_folder = os.path.join(path_folder, r'Datasets LIDAR\kitti\range_images_16ch_2048_filter_ego_motion') #Low resolution images path
hr_folder = os.path.join(path_folder, r'Datasets LIDAR\kitti\range_images_64ch_2048_filter_ego_motion') #High resolution images path
